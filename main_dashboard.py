# main.py - Resume AI Toolkit (OpenRouter Powered)
...
# Load sidebar logo if it exists
try:
...
st.markdown("""
**Powered by OpenRouter** • Your all-in-one solution for job applications  
